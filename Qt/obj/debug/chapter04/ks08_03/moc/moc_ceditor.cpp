...
#include "../../../../../src/chapter08/ks08_03/ceditor.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CEditor_t, stringdata) + ofs \
...
void CEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CEditor::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CEditor::editingFinished)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CEditor::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_CEditor.data,
      qt_meta_data_CEditor,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CEditor.stringdata))
