...
#include "../../../../../src/chapter08/ks08_03/tablemodel.h"
...
struct qt_meta_stringdata_CTableModel_t {
    QByteArrayData data[1];
    char stringdata[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_CTableModel_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_CTableModel_t qt_meta_stringdata_CTableModel = {
    {
...
const QMetaObject CTableModel::staticMetaObject = {
    { &QStandardItemModel::staticMetaObject, qt_meta_stringdata_CTableModel.data,
      qt_meta_data_CTableModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CTableModel.stringdata))
