...
#include "../../../../../src/chapter05/ks05_02/dialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 35, 18)
    ...
    "CDialog\0on_fontFamilyChanged\0\0font\0"
    "on_fontSizeChanged\0"
};
...
void CDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_fontFamilyChanged((*reinterpret_cast< const QFont(*)>(_a[1]))); break;
        case 1: _t->on_fontSizeChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject CDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CDialog.data,
      qt_meta_data_CDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CDialog.stringdata))
        return static_cast<void*>(const_cast< CDialog*>(this));
    if (!strcmp(_clname, "Ui::CDialogBase"))
        return static_cast< Ui::CDialogBase*>(const_cast< CDialog*>(this));
