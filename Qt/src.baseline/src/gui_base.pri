#########################################################################################
# 注意：此文件用于放置 IES800BUS 各子项目 QT 工程文件的公共(基本)设置，
# 在各 QT 工程文件中通过 include 函数包含，不应单独使用！
# 开发人员需要定义下面几个系统环境变量：
# TRAINDEVHOME		IES800BUS系统开发主目录，放置与开发相关的各个子模块 (必须定义)
# TRAINBUILDTYPE		IES800BUS系统编译版本定义，指定编译版本类型：debug|release
# TRAINBUILDBIT		IES800BUS系统程序编译位数定义，指定编译位数：32|64
#########################################################################################
