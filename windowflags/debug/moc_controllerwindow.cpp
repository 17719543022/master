...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ControllerWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 31, 0)
    ...
    "ControllerWindow\0updatePreview\0\0"
};
...
const QMetaObject ControllerWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ControllerWindow.data,
      qt_meta_data_ControllerWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ControllerWindow.stringdata))
